...
/**
 * A core.Sha256Hash just wraps a byte[] so that equals and hashcode work correctly, allowing it to be used as keys in a
...
public class Sha256Hash implements Serializable {
    ...
    /**
     * Creates a core.Sha256Hash by wrapping the given byte array. It must be 32 bytes long.
     */
    ...
    /**
     * Creates a core.Sha256Hash by decoding the given hex string. It must be 64 characters long.
     */
