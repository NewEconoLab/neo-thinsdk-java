...
public class Address extends VersionedChecksummedBytes {
    ...
    public Address(String encoded) throws AddressFormatException{
        super(encoded);
    }
     ...
     *
     * <pre>new core.Address(core.NetworkParameters.prodNet(), Hex.decode("4a22c3c4cbb31e4d03b15550636762bda0baf85a"));</pre>
     */
